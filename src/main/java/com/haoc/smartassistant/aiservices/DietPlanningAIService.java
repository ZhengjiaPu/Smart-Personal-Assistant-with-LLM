...
@AiService
public interface DietPlanningAIService {
    ...
    @SystemMessage("""
            ...
            """)
    public String generateDietPlan(String userBodyData);
    ...
    @SystemMessage("""
            ...
            """)
    public String adjustDietPlan(String userBodyData, String adjustmentCommand);
}
